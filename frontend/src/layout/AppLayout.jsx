...
import { AppBar, Toolbar, Typography, CssBaseline, Drawer, List, ListItem, ListItemButton, ListItemText, Box } from '@mui/material';
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <AppBar position="fixed" sx={{ zIndex: (theme)=> theme.zIndex.drawer + 1 }}>
        <Toolbar>
          <Typography variant="h6" noWrap component="div">ExpenseWise</Typography>
          <Box sx={{ flexGrow:1 }} />
